...
const Key KEY_A_U(2, new char[2]{ '\x04' , '\xE1' });
const Key KEY_B_U(2, new char[2]{ '\x05' , '\xE1' });
const Key KEY_C_U(2, new char[2]{ '\x06' , '\xE1' });
const Key KEY_D_U(2, new char[2]{ '\x07' , '\xE1' });
const Key KEY_E_U(2, new char[2]{ '\x08' , '\xE1' });
const Key KEY_F_U(2, new char[2]{ '\x09' , '\xE1' });
const Key KEY_G_U(2, new char[2]{ '\x0A' , '\xE1' });
const Key KEY_H_U(2, new char[2]{ '\x0B' , '\xE1' });
const Key KEY_I_U(2, new char[2]{ '\x0C' , '\xE1' });
const Key KEY_J_U(2, new char[2]{ '\x0D' , '\xE1' });
const Key KEY_K_U(2, new char[2]{ '\x0E' , '\xE1' });
const Key KEY_L_U(2, new char[2]{ '\x0F' , '\xE1' });
const Key KEY_M_U(2, new char[2]{ '\x10' , '\xE1' });
const Key KEY_N_U(2, new char[2]{ '\x11' , '\xE1' });
const Key KEY_O_U(2, new char[2]{ '\x12' , '\xE1' });
const Key KEY_P_U(2, new char[2]{ '\x13' , '\xE1' });
const Key KEY_Q_U(2, new char[2]{ '\x14' , '\xE1' });
const Key KEY_R_U(2, new char[2]{ '\x15' , '\xE1' });
const Key KEY_S_U(2, new char[2]{ '\x16' , '\xE1' });
const Key KEY_T_U(2, new char[2]{ '\x17' , '\xE1' });
const Key KEY_U_U(2, new char[2]{ '\x18' , '\xE1' });
const Key KEY_V_U(2, new char[2]{ '\x19' , '\xE1' });
const Key KEY_W_U(2, new char[2]{ '\x1A' , '\xE1' });
const Key KEY_X_U(2, new char[2]{ '\x1B' , '\xE1' });
const Key KEY_Y_U(2, new char[2]{ '\x1C' , '\xE1' });
const Key KEY_Z_U(2, new char[2]{ '\x1D' ,'\xE1' });
